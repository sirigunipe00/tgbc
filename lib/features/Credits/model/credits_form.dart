...
part 'credits_form.freezed.dart';
part 'credits_form.g.dart';

@freezed
class CreditsForm with _$CreditsForm {
  const factory CreditsForm({
  ...
  factory CreditsForm.fromJson(Map<String, Object?> json) =>
      _$CreditsFormFromJson(json);
}

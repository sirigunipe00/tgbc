...
_$Unit2assemblyFormImpl _$$Unit2assemblyFormImplFromJson(
        Map<String, dynamic> json) =>
    _$Unit2assemblyFormImpl(
...
Map<String, dynamic> _$$Unit2assemblyFormImplToJson(
        _$Unit2assemblyFormImpl instance) =>
    <String, dynamic>{
      'name': instance.name,

...
part 'unit2_assembly_form.freezed.dart';
part 'unit2_assembly_form.g.dart';

@freezed
class Unit2assemblyForm with _$Unit2assemblyForm {
  const factory Unit2assemblyForm({
  ...
  factory Unit2assemblyForm.fromJson(Map<String, Object?> json) =>
      _$Unit2assemblyFormFromJson(json);
}

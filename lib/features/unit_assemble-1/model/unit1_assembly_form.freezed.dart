...
part of 'unit1_assembly_form.dart';
...
UnitassemblyForm _$UnitassemblyFormFromJson(Map<String, dynamic> json) {
  return _UnitassemblyForm.fromJson(json);
}

/// @nodoc
mixin _$UnitassemblyForm {
  @JsonKey(name: 'name')
  ...
  @JsonKey(ignore: true)
  $UnitassemblyFormCopyWith<UnitassemblyForm> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UnitassemblyFormCopyWith<$Res> {
  factory $UnitassemblyFormCopyWith(
          UnitassemblyForm value, $Res Function(UnitassemblyForm) then) =
      _$UnitassemblyFormCopyWithImpl<$Res, UnitassemblyForm>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UnitassemblyFormCopyWithImpl<$Res, $Val extends UnitassemblyForm>
    implements $UnitassemblyFormCopyWith<$Res> {
  _$UnitassemblyFormCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UnitassemblyFormImplCopyWith<$Res>
    implements $UnitassemblyFormCopyWith<$Res> {
  factory _$$UnitassemblyFormImplCopyWith(_$UnitassemblyFormImpl value,
          $Res Function(_$UnitassemblyFormImpl) then) =
      __$$UnitassemblyFormImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'name') String? name,
...
/// @nodoc
class __$$UnitassemblyFormImplCopyWithImpl<$Res>
    extends _$UnitassemblyFormCopyWithImpl<$Res, _$UnitassemblyFormImpl>
    implements _$$UnitassemblyFormImplCopyWith<$Res> {
  __$$UnitassemblyFormImplCopyWithImpl(_$UnitassemblyFormImpl _value,
      $Res Function(_$UnitassemblyFormImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UnitassemblyFormImpl(
      name: freezed == name
          ? _value.name
          : name // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$UnitassemblyFormImpl implements _UnitassemblyForm {
  const _$UnitassemblyFormImpl(
  ...
  factory _$UnitassemblyFormImpl.fromJson(Map<String, dynamic> json) =>
      _$$UnitassemblyFormImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UnitassemblyFormImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UnitassemblyFormImplCopyWith<_$UnitassemblyFormImpl> get copyWith =>
      __$$UnitassemblyFormImplCopyWithImpl<_$UnitassemblyFormImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UnitassemblyFormImplToJson(
      this,
    );
  }
}

abstract class _UnitassemblyForm implements UnitassemblyForm {
  const factory _UnitassemblyForm(
      ...
      @JsonKey(name: 'component_scanning_puf', defaultValue: [])
      required final List<ItemsForm> items}) = _$UnitassemblyFormImpl;

  factory _UnitassemblyForm.fromJson(Map<String, dynamic> json) =
      _$UnitassemblyFormImpl.fromJson;

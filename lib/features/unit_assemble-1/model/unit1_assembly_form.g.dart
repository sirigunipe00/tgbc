...
_$UnitassemblyFormImpl _$$UnitassemblyFormImplFromJson(
        Map<String, dynamic> json) =>
    _$UnitassemblyFormImpl(
...
Map<String, dynamic> _$$UnitassemblyFormImplToJson(
        _$UnitassemblyFormImpl instance) =>
    <String, dynamic>{
      'name': instance.name,

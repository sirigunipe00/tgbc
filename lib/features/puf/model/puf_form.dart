...
part 'puf_form.freezed.dart';
part 'puf_form.g.dart';

@freezed
class PufForm with _$PufForm {
  const factory PufForm({
  ...
  factory PufForm.fromJson(Map<String, Object?> json) =>
      _$PufFormFromJson(json);
}

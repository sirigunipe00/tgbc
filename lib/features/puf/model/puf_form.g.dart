...
_$PufFormImpl _$$PufFormImplFromJson(Map<String, dynamic> json) =>
    _$PufFormImpl(
      ...
      scanVal: json['scan_value_barcode'] as String?,
...
Map<String, dynamic> _$$PufFormImplToJson(_$PufFormImpl instance) =>
    <String, dynamic>{
      'name': instance.name,
      ...
      'scan_value_barcode': instance.scanVal,
